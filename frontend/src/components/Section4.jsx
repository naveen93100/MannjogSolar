            ...
            <div className='w-full'>
                ...
                <div className=' mx-auto max-w-[1024px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-3 md:grid-cols-2 justify-items-center space-y-1'>
                    {cardData.map((item, index) => (
                        <div key={index} className='w-40 h-40 md:w-64 hover:scale-105 transition-all ease-in-out  p-2  border-2 border-gray-300 hover:shadow rounded-2xl bg-white text-gray-800 text-sm md:text-lg flex items-center justify-center text-center font-medium '>
                            <b>
